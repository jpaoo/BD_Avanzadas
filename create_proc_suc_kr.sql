-- PROCEDIMIENTOS Y TRIGGERS PARA USUARIO a1700666 INSTANCIA slp 

-- INICIA PROCEDIMIENTO NUEVO_LIBRO
...
-- TERMINA PROCEDIMIENTO NUEVO_LIBRO

-- INICIA PROCEDIMIENTO NUEVO GÉNERO
...
-- TERMINA PROCEDIMIENTO NUEVO GÉNERO

-- INICIA PROCEDIMIENTO NUEVO PROVEEDOR
...
-- TERMINA PROCEDIMIENTO NUEVO PROVEEDOR

-- INICIA PROCEDIMIENTO NUEVA EDITORIAL
...
-- TERMINA PROCEDIMIENTO NUEVA EDITORIAL

-- INICIA PROCEDIMIENTO NUEVO AUTOR
...
-- TERMINA PROCEDIMIENTO NUEVO AUTOR

-- INICIA PROCEDIMIENTO UPDATE PRECIO LIBRO
...
-- TERMINA PROCEDIMIENTO UPDATE PRECIO LIBRO

-- INICIA PROCEDIMIENTO UPDATE COSTO LIBRO
...
-- TERMINA PROCEDIMIENTO UPDATE COSTO LIBRO

-- INICIA PROCEDIMIENTO UPDATE MAIL CLIENTE
...
-- TERMINA PROCEDIMIENTO UPDATE MAIL CLIENTE

-- INICIA PROCEDIMIENTO UPDATE TELEFONO CLIENTE
...
-- INICIA TRIGGER DESCUENTO DE 1000 COMPRAS
...
-- TERMINA TRIGGER DESCUENTO DE 1000 COMPRAS
