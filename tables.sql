...
ALTER TABLE PROYECTO_LIBROSSUCURSAL ADD CONSTRAINT FK_LIBRO FOREIGN KEY (ID_LIBRO) REFERENCES PROYECTO_LIBROS(ID_LIBRO);
ALTER TABLE PROYECTO_LIBROSSUCURSAL ADD CONSTRAINT FK_SUCURSAL FOREIGN KEY (ID_SUCURSAL) REFERENCES PROYECTO_SUCURSALES(ID_SUCURSAL);
