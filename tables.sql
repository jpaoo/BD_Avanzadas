...
CREATE DATABASE LINK "KR.SLP.ITESM.MX" CONNECT TO "A12700666" IDENTIFIED BY VALUES "bnJfdSwQ" USING 'slp';
CREATE DATABASE LINK "MM.QRO.ITESM.MX" CONNECT TO "A1204818" IDENTIFIED BY VALUES "h3gm0VsO" USING 'qro';
CREATE DATABASE LINK "MC.SLP.ITESM.MX" CONNECT TO "A1271656" IDENTIFIED BY VALUES "oc0sCj7s" USING 'slp';
